...
const Dashboard: React.FC = () => {
  ...
  const localStoragedRepositoriesKey = '@GithubExplorer:repositories'
  const [repositories, setRepositories] = useState<Repository[]>(() => {
    const storagedRepositories = localStorage.getItem(localStoragedRepositoriesKey)
  ...
  useEffect(() => {
    localStorage.setItem(localStoragedRepositoriesKey, JSON.stringify(repositories))
  }, [repositories])
